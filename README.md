# Hi, I'm Alberto Irazza 👋

**PhD in Artificial Intelligence — Time Series | AI Engineer | Starting Postdoc in Reinforcement Learning**

I'm Alberto Irazza ([@irazza](https://github.com/irazza)), PhD in AI from Politecnico di Torino. I work on time series under different aspects — distances, features, and evaluation — and I build fast, production-ready tools in **Rust + Python**. I spent 6 months at **Accenture as an AI Engineer for banking systems**, and I'm now starting a **postdoc in Reinforcement Learning**.
...
- 🎓 **PhD in Artificial Intelligence, Politecnico di Torino** — focus on time series analysis
- ⏱️ Worked on time series from multiple angles: elastic distances, feature extraction, statistical comparison
...
*PhD thesis on time series? — TODO: tell me your thesis title + 2-3 key results/publications and I'll add a dedicated section with links.*
